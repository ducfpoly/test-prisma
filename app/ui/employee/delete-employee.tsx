...
export default async function DeleteEmployee({employeeId}: {employeeId: number}){
    const deleteEmployeeWithId = deleteEmployee.bind(null, employeeId);
    return (
        <div>
           <form className="font-medium text-blue-600 dark:text-blue-500" action={deleteEmployeeWithId}>
                <button
                    title="delte" 
